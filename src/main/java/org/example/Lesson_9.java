...
public class Lesson_9 {
    public static void main(String[] args) {
        ...
        // Cгенерировать поток случайных чисел
        int size = 60; // Количество чисел в потоке
        IntStream randomNumbers = random
                .ints(size, 1, 100); // числа от 1 до 100

        // Подсчитать четные числа
        ...
        //Task №2.
        System.out.println("\nTask №2. Задать коллекцию, состоящую из строк:" +
                "«Highload», «High», «Load», «Highload».");
        List<String> collection = Arrays.asList("Highload", "High", "Load", "Highload");
        // №2.1.
        System.out.println("\nTask №2.1.Посчитать, сколько раз объект «High» встречается в коллекции;");
        ...
        // №2.2.
        System.out.println("\nTask №2.2.. Определить, какой элемент в коллекции находится на первом месте. Если мы " +
                "получили пустую коллекцию, то пусть возвращается 0;");
        String a = collection.stream().findFirst().orElse("0");
        System.out.println("Какой элемент в колеции находится на первом месте: " + a);
        // №2.3.
        System.out.println("\nTask №2.3.Необходимо вернуть последний элемент, если получили пустую коллекцию, то пусть " +
                "возвращается 0;");
        ...
        //Task 3
        System.out.println("\nTask №3.Задана коллекция, содержащая элементы \"f10\", \"f15\", \"f2\", \"f4\", \"f4\". " +
        ...
        //Task №4
        System.out.println("\nTask №4. Создай класс со следующим содержимым:");
